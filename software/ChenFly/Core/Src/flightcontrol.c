...
extern mavlink_param_value_t param[PARAMCOUNT];
...
void init_flightcontrol(void)
{
	...
	param[0].param_value = roll_P;
	param[1].param_value = roll_I;
	param[2].param_value = roll_D;
	param[3].param_value = pitch_P;
	param[4].param_value = pitch_I;
	param[5].param_value = pitch_D;
	param[6].param_value = yaw_P;
	param[7].param_value = yaw_I;
	param[8].param_value = yaw_D;
}
